...
step "Finishing"; log "Ehecatl binaries/project removed."; log "Custom data in $ETC_BASE_DIR, $VAR_BASE_DIR, and $SRV_BASE_DIR was preserved."; log "Redis was intentionally left untouched. Run setup/uninstall-redis.sh only if Ehecatl previously managed a local Redis installation."
