...
step "Finishing"; log "Ehecatl custom data removed."; log "Redis was intentionally left untouched. Use setup/uninstall-redis.sh only if a local Redis installation was previously managed by Ehecatl."
