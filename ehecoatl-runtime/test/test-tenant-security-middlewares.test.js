...
const sessionMiddleware = require(`../extensions/tenant-kits/test-tenant/shared/app/http/middlewares/session`);
const csrfMiddleware = require(`../extensions/tenant-kits/test-tenant/shared/app/http/middlewares/csrf`);
const corsMiddleware = require(`../extensions/tenant-kits/test-tenant/shared/app/http/middlewares/cors`);
const authMiddleware = require(`../extensions/tenant-kits/test-tenant/shared/app/http/middlewares/auth`);
const guestMiddleware = require(`../extensions/tenant-kits/test-tenant/shared/app/http/middlewares/guest`);
const authLoginAction = require(`../extensions/app-kits/test-app/app/http/actions/auth-login`);
const authLogoutAction = require(`../extensions/app-kits/test-app/app/http/actions/auth-logout`);
const authSessionAction = require(`../extensions/app-kits/test-app/app/http/actions/auth-session`);
