...
const TenantDirectoryResolverPort = require(`@/_core/_ports/outbound/tenant-directory-resolver-port`);
...
function resolveTenantSourceFolders(rootFolder) {
  return {
    actionsRootFolder: path.join(rootFolder, tenantActionsFolderName),
    ...
    routesRootFolder: path.join(rootFolder, tenantRoutesFolderName)
  };
}
