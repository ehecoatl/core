// _core/gateways/shared/storage-service/storage-service.js
...
/** Shared service gateway that wraps storage adapter operations with plugin hook instrumentation. */
class StorageService extends GatewayCore {
  /** @type {typeof import('@/config/default.config')['storageService']} */
  config;
  /** @type {import('@/_core/boot/plugin-executor')} */
  plugin;
  storageHooks;
  /** @type {import('./storage-service-adapter')} */
  adapter = null;
  ...
  constructor(kernelContext) {
    ...
    this.config = kernelContext.config.storageService;
