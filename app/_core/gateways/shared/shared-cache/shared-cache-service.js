// _core/gateways/shared/shared-cache/shared-cache-service.js
...
/** Shared cache gateway that wraps cache adapter calls with plugin hook instrumentation. */
class SharedCacheService extends GatewayCore {
  #connectPromise = null;
  /** @type {typeof import('@/config/default.config').sharedCacheService} */
  config;
  /** @type {import('@/_core/boot/plugin-executor')} */
  plugin;
  sharedCacheHooks;
  failurePolicy;
  /** @type {import('./shared-cache-service-adapter')} */
  adapter = null;
  ...
  constructor(kernelContext) {
    ...
    this.config = kernelContext.config.sharedCacheService;
