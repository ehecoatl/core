// adapters/manager/queue-broker/event-memory.js


'use strict';


const QueueBrokerAdapter = require(`g@/manager/queue-broker/queue-broker-adapter`);
...
QueueBrokerAdapter.appendToQueueAdapter = async (
...
QueueBrokerAdapter.removeFromQueueAdapter = (
  { queueLabel, taskId }
) => {
  const queue = activeQueue[queueLabel];
...
QueueBrokerAdapter.removeTasksByOriginAdapter = (
  { origin }
) => {
...
module.exports = QueueBrokerAdapter;
Object.freeze(QueueBrokerAdapter);
