...
- Releases can be listed, downloaded into `~/ehecoatl/<release>`, and then installed from that cached checkout.
...
- Install handoff runs the downloaded release's `setup/bootstrap.sh --auto-install`.
